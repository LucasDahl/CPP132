...
/*
 ...
 ====================================================================================================================
 Input iterator         - Reads forwad                     - istream
 Output iterator        - Writes forward                   - ostream, inserter
 Forward iterator       - Reads/writes forward             - forward_list unordered_[multi]set, unordered_[multi]map
 Bidirectional iterator - Reads/writes forward/backward    - list,[multi]set, [multi]map
 Random access iterator - Reads/writes with random access  - vector, deque string, array
 ====================================================================================================================
